...
namespace Bitwise_Ops_Week_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Enter integer for x: ");
            string xInt = Console.ReadLine();
            int x = Convert.ToInt32(xInt);
            Console.Write("Enter integer for y: ");
            ...
            int exclOR = x ^ y;
            // Compares two bits and returns 1 if either of the bits are 1 and it gives 0 if both bits are 0 or 1.
            Console.WriteLine();
            Console.WriteLine($"The AND value is: {AND}");
            Console.WriteLine($"The inclusive OR value is: {inclOR}");
            Console.WriteLine($"The exclusive OR value is: {exclOR}");
